...
class Request
{
    ...
    public function isAjax($ajax = false)
    {
        ...
        // $value2  = $_SERVER['HTTP_ACCEPT'];//application/json, text/javascript, */*; q=0.01  跨域ajax所带的数据
        // $str = 'application/json, text/javascript';
        // //判断是否携带此字符串
        // $f = stripos($value2,$str)===false?false:true;
        // $result = ('xmlhttprequest' == $value) || $f ? true : false;
        // if (true === $ajax) {
        //     return $result;
        // } else {
