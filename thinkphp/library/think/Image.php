...
class Image
{
    ...
    protected function __construct(\SplFileInfo $file)
    {
        ...
        $memoryNeeded = round(($info[0] * $info[1] * $info['bits'] * $info['channels'] / 8 + Pow(2, 16)) * 2.5);                            
        ...
        // var_dump((integer) ini_get('memory_limit') + ceil(((memory_get_usage() + $memoryNeeded) - (integer) ini_get('memory_limit') * pow(1024, 2)) / pow(1024, 2)));
